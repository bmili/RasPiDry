...
This system is an inexpensive and flexible wireless  Web based controller for drying Fruit, Fruit leather, Vegetables, Yoghurt making and Raising Bread.  You can use your own homemade or some commercial dehydrator. The system is connected to Amazon cloud using AWS internet of things to smart control<!--The most recent updates for this application are found on the RasPiDry project page on Github.-->
