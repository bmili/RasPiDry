Simple Complete Raspberry Pi & RasPiDry Software Installation from Windows
---------------------------------------------------------------------------
...
9) Type: 'sudo git clone https://github.com/bmili/RasPiDry.git /var/www'
10) Use Putty to log onto the Raspberry Pi
11) Type: 'chmod +x raspidry_setup.sh' to make it executable
12) Type: 'sudo ./raspidry_setup.sh' and follow prompts
...
Note: In RasPiDry directory type 'sudo git fetch' to get the latest version.
